...
<%
  List<Goal> resources = (List<Goal>) request.getAttribute("resources");
...
<head>
  ...
  <title>Query capability QueryCapabilityGoal</title>
...
<!-- Fixed navbar -->
  ...
  <div class="container">
    <div class="page-header">
      <h1>Query Capability &quot;QueryCapabilityGoal&quot; results</h1>
