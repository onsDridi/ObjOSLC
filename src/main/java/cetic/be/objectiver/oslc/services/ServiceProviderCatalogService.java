...
public class ServiceProviderCatalogService
{
    ...
    public ServiceProviderCatalog getServiceProviderCatalog(@PathParam("serviceProviderCatalogId") final String serviceProviderCatalogId)
    {
        ...
        if (catalog != null) {
            httpServletResponse.addHeader(ObjectiverConstants.HDR_OSLC_VERSION,"2.0");
            return catalog;
        }
    ...
    public void getHtmlServiceProvider(@PathParam("somxxxeId") final String someId)
    {
        ServiceProviderCatalog catalog = ServiceProviderCatalogSingleton.getServiceProviderCatalog(httpServletRequest);
        ...
        if (catalog !=null )
        {
            ...
            RequestDispatcher rd = httpServletRequest.getRequestDispatcher("/cetic/be/objectiver/oslc/serviceprovidercatalog.jsp");
            try {
