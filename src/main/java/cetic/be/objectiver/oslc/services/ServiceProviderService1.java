...
public class ServiceProviderService1
{
    ...
    @OslcQueryCapability
    (
        title = "QueryCapabilityGoal",
        label = "QueryCapabilityGoal",
        resourceShape = OslcConstants.PATH_RESOURCE_SHAPES + "/" + Oslc_objectiverDomainConstants.GOAL_PATH,
        resourceTypes = {Oslc_objectiverDomainConstants.GOAL_TYPE},
        usages = {}
                                                     ...
                                                     @QueryParam("oslc.pageSize") final String pageSizeString) throws IOException, ServletException
    {
        ...
        // Here additional logic can be implemented that complements main action taken in ObjectiverManager
        // End of user code

        final List<Goal> resources = ObjectiverManager.queryGoals(httpServletRequest, projectid, where, prefix, paging, page, pageSize);
        ...
        return resources.toArray(new Goal [resources.size()]);
    }
                                       ...
                                       @QueryParam("oslc.pageSize") final String pageSizeString) throws ServletException, IOException
    {
        ...
        // Start of user code queryGoalsAsHtml
        // End of user code
        ...
        if (resources!= null) {
            ...
            // Start of user code queryGoalsAsHtml_setAttributes
            // End of user code
            ...
            RequestDispatcher rd = httpServletRequest.getRequestDispatcher("/cetic/be/objectiver/oslc/goalscollection.jsp");
    ...
    /**
     * Create a single Goal via RDF/XML, XML or JSON POST
     *
     * @throws IOException
    ...
    @OslcCreationFactory
    (
         title = "CreationFactoryGoal",
         label = "CreationFactoryGoal",
         resourceShapes = {OslcConstants.PATH_RESOURCE_SHAPES + "/" + Oslc_objectiverDomainConstants.GOAL_PATH},
         resourceTypes = {Oslc_objectiverDomainConstants.GOAL_TYPE},
         usages = {}
    )
    @POST
    ...
    @Produces({OslcMediaType.APPLICATION_RDF_XML, OslcMediaType.APPLICATION_JSON_LD, OslcMediaType.TEXT_TURTLE, OslcMediaType.APPLICATION_XML, OslcMediaType.APPLICATION_JSON})
    @Operation(
        summary = "Creation factory for resources of type {" + Oslc_objectiverDomainConstants.GOAL_LOCALNAME + "}",
        description = "Creation factory for resources of type {" + "<a href=\"" + Oslc_objectiverDomainConstants.GOAL_TYPE + "\">" + Oslc_objectiverDomainConstants.GOAL_LOCALNAME + "</a>" + "}" +
            ", with respective resource shapes {" + "<a href=\"" + "../services/" + OslcConstants.PATH_RESOURCE_SHAPES + "/" + Oslc_objectiverDomainConstants.GOAL_PATH + "\">" + Oslc_objectiverDomainConstants.GOAL_LOCALNAME + "</a>" + "}",
        responses = { 
    ...
    {
        Goal newResource = ObjectiverManager.createGoal(httpServletRequest, aResource);
        httpServletResponse.setHeader("ETag", ObjectiverManager.getETagFromGoal(newResource));
        return Response.created(newResource.getAbout()).entity(newResource).header(ObjectiverConstants.HDR_OSLC_VERSION, ObjectiverConstants.OSLC_VERSION_V2).build();
    }
    ...
    public Response GoalCreator(
                
        ) throws IOException, ServletException
    {
        // Start of user code GoalCreator
        // End of user code
        ...
        RequestDispatcher rd = httpServletRequest.getRequestDispatcher("/cetic/be/objectiver/oslc/goalcreator.jsp");
        rd.forward(httpServletRequest, httpServletResponse);
        return null;
    }
    ...
    public void createGoalFromDialog(MultivaluedMap<String, String> formParams
            
        ) throws URISyntaxException, ParseException {
        Goal newResource = null;

        Goal aResource = new Goal();

        List<String> paramValues;

        paramValues = formParams.get("name");
        if (paramValues != null) {
                if (paramValues.size() == 1) {
                    if (paramValues.get(0).length() != 0)
                        aResource.setName(paramValues.get(0));
        ...
        if (paramValues != null) {
                if (paramValues.size() == 1) {
                    if (paramValues.get(0).length() != 0)
                        aResource.setType(paramValues.get(0));
                    // else, there is an empty value for that parameter, and hence ignore since the parameter is not actually set.
                }

        }
        paramValues = formParams.get("def");
        if (paramValues != null) {
                if (paramValues.size() == 1) {
                    if (paramValues.get(0).length() != 0)
                        aResource.setDef(paramValues.get(0));
                    // else, there is an empty value for that parameter, and hence ignore since the parameter is not actually set.
                }
        ...
        paramValues = formParams.get("category");
        if (paramValues != null) {
                if (paramValues.size() == 1) {
                    if (paramValues.get(0).length() != 0)
                        aResource.setCategory(paramValues.get(0));
                    // else, there is an empty value for that parameter, and hence ignore since the parameter is not actually set.
                }

        }
        paramValues = formParams.get("issue");
        if (paramValues != null) {
                if (paramValues.size() == 1) {
                    if (paramValues.get(0).length() != 0)
                        aResource.setIssue(paramValues.get(0));
                    // else, there is an empty value for that parameter, and hence ignore since the parameter is not actually set.
                }

        }
        paramValues = formParams.get("externalId");
        if (paramValues != null) {
                if (paramValues.size() == 1) {
                    if (paramValues.get(0).length() != 0)
                        aResource.setExternalId(paramValues.get(0));
                    // else, there is an empty value for that parameter, and hence ignore since the parameter is not actually set.
                }

        }
        paramValues = formParams.get("openId");
        if (paramValues != null) {
                if (paramValues.size() == 1) {
                    if (paramValues.get(0).length() != 0)
                        aResource.setOpenId(paramValues.get(0));
                    // else, there is an empty value for that parameter, and hence ignore since the parameter is not actually set.
                }

        }
        paramValues = formParams.get("diagrams");
        if (paramValues != null) {
                for(int i=0; i<paramValues.size(); i++) {
                    aResource.addDiagrams(Integer.valueOf(paramValues.get(i)));
                }
        }
        paramValues = formParams.get("refdiagrams");
        if (paramValues != null) {
                for(int i=0; i<paramValues.size(); i++) {
                    aResource.addRefdiagrams(Integer.valueOf(paramValues.get(i)));
                }
        }

        newResource = ObjectiverManager.createGoalFromDialog(httpServletRequest, aResource);
