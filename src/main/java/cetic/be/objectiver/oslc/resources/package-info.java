...
@OslcSchema ({
    ...
    @OslcNamespaceDefinition(prefix = Oslc_objectiverDomainConstants.OBJECTIVERWEB_NAMSPACE_PREFIX, namespaceURI = Oslc_objectiverDomainConstants.OBJECTIVERWEB_NAMSPACE)
})
